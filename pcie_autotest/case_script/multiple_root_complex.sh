...
export g_fn_multiple_root_complex_common=${g_fnCur}
export g_dp_multiple_root_complex_common=${g_dpCur}
...
MultipleRootComplex()
{
    ...
    LspcikKeysiBA "Kernel driver in use: \(ixgbe\|mpt3sas\|igb\|hibmc-drm\|nvme\)"
}
